...
const handleChangeRightSlide = () => {
  if (current_index_slide_header == length_slide_header_img - 1) {
    ...
    document
      .querySelector(".index-" + current_index_slide_header)
      .classList.add("active");
  } else {
    current_index_slide_header++;
    let width_slide_header = imgs_slide_header[0].offsetWidth;
    list_image_header.style.transform = `translateX(${
      width_slide_header * -1 * current_index_slide_header
    }px)`;
    document.querySelector(".active").classList.remove("active");
    document
      .querySelector(".index-" + current_index_slide_header)
...
//  fix
document
  .getElementById("button_forgotpassword")
  .addEventListener("click", function () {
...
const imgs_slide_header = document.querySelectorAll(
  "#slide-header .list-images img"
);
...
const btn_right_slide_header = document.querySelector(
  "#slide-header .btn-right"
);
...
// coming-soon
const cardItems_coming_soon = document.querySelectorAll(
